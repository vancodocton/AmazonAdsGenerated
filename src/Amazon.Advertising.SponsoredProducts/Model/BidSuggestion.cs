...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// Suggested bid range
    /// </summary>
    [DataContract(Name = "BidSuggestion")]
    public partial class BidSuggestion : IEquatable<BidSuggestion>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BidSuggestion" /> class.
        /// </summary>
        /// <param name="suggested">The suggested bid.</param>
        /// <param name="rangeStart">The bid range start.</param>
        /// <param name="bidRecId">The bid recommendation id.</param>
        /// <param name="rangeEnd">The bid range end.</param>
        public BidSuggestion(double suggested = default(double), double rangeStart = default(double), string bidRecId = default(string), double rangeEnd = default(double))
        {
        ...
        /// </summary>
        /// <value>The bid recommendation id</value>
        [DataMember(Name = "bidRecId", EmitDefaultValue = false)]
        public string BidRecId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BidRecId: ").Append(BidRecId).Append("\n");
        ...
        {
            return this.Equals(input as BidSuggestion);
        }

        /// <summary>
        /// Returns true if BidSuggestion instances are equal
        /// </summary>
        /// <param name="input">Instance of BidSuggestion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BidSuggestion input)
        {
            if (input == null)
            {
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BidRecId != null)
                {
                    hashCode = (hashCode * 59) + this.BidRecId.GetHashCode();
                }
