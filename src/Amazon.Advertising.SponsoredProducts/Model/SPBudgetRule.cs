...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// SPBudgetRule
    /// </summary>
    [DataContract(Name = "SPBudgetRule")]
    public partial class SPBudgetRule : IEquatable<SPBudgetRule>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SPBudgetRule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SPBudgetRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SPBudgetRule" /> class.
        /// </summary>
        ...
        public SPBudgetRule(State? ruleState = default(State?), decimal lastUpdatedDate = default(decimal), decimal createdDate = default(decimal), SPBudgetRuleDetails ruleDetails = default(SPBudgetRuleDetails), string ruleId = default(string), string ruleStatus = default(string))
        {
            // to ensure "ruleId" is required (not null)
            if (ruleId == null)
            {
                throw new ArgumentNullException("ruleId is a required property for SPBudgetRule and cannot be null");
            }
            this.RuleId = ruleId;
        ...
        {
            return this.Equals(input as SPBudgetRule);
        }

        /// <summary>
        /// Returns true if SPBudgetRule instances are equal
        /// </summary>
        /// <param name="input">Instance of SPBudgetRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SPBudgetRule input)
        {
            if (input == null)
            {
                return false;
