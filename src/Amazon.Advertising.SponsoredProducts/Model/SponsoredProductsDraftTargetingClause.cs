...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftTargetingClause")]
    public partial class SponsoredProductsDraftTargetingClause : IEquatable<SponsoredProductsDraftTargetingClause>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftTargetingClause" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsDraftTargetingClause() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftTargetingClause" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftTargetingClause(List<SponsoredProductsTargetingExpressionPredicate> expression = default(List<SponsoredProductsTargetingExpressionPredicate>), string targetId = default(string), List<SponsoredProductsTargetingExpressionPredicate> resolvedExpression = default(List<SponsoredProductsTargetingExpressionPredicate>), string campaignId = default(string), SponsoredProductsExpressionType expressionType = default(SponsoredProductsExpressionType), SponsoredProductsEntityState? state = default(SponsoredProductsEntityState?), double? bid = default(double?), string adGroupId = default(string), SponsoredProductsDraftTargetingClauseExtendedData extendedData = default(SponsoredProductsDraftTargetingClauseExtendedData))
        {
            // to ensure "expression" is required (not null)
            if (expression == null)
            {
                throw new ArgumentNullException("expression is a required property for SponsoredProductsDraftTargetingClause and cannot be null");
            }
            this.Expression = expression;
            // to ensure "targetId" is required (not null)
            if (targetId == null)
            {
                throw new ArgumentNullException("targetId is a required property for SponsoredProductsDraftTargetingClause and cannot be null");
            }
            this.TargetId = targetId;
            // to ensure "resolvedExpression" is required (not null)
            if (resolvedExpression == null)
            {
                throw new ArgumentNullException("resolvedExpression is a required property for SponsoredProductsDraftTargetingClause and cannot be null");
            }
            this.ResolvedExpression = resolvedExpression;
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsDraftTargetingClause and cannot be null");
            }
            ...
            if (adGroupId == null)
            {
                throw new ArgumentNullException("adGroupId is a required property for SponsoredProductsDraftTargetingClause and cannot be null");
            }
        ...
        public SponsoredProductsDraftTargetingClauseExtendedData ExtendedData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftTargetingClause {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftTargetingClause);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftTargetingClause instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftTargetingClause to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftTargetingClause input)
        {
            if (input == null)
            {
                return false;
