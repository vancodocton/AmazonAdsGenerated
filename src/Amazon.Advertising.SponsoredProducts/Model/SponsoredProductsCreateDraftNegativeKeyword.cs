...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsCreateDraftNegativeKeyword")]
    public partial class SponsoredProductsCreateDraftNegativeKeyword : IEquatable<SponsoredProductsCreateDraftNegativeKeyword>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCreateDraftNegativeKeyword" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsCreateDraftNegativeKeyword() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCreateDraftNegativeKeyword" /> class.
        /// </summary>
        ...
        public SponsoredProductsCreateDraftNegativeKeyword(string nativeLanguageKeyword = default(string), string nativeLanguageLocale = default(string), string campaignId = default(string), SponsoredProductsCreateOrUpdateNegativeMatchType matchType = default(SponsoredProductsCreateOrUpdateNegativeMatchType), string adGroupId = default(string), string keywordText = default(string))
        {
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsCreateDraftNegativeKeyword and cannot be null");
            }
            ...
            if (adGroupId == null)
            {
                throw new ArgumentNullException("adGroupId is a required property for SponsoredProductsCreateDraftNegativeKeyword and cannot be null");
            }
            this.AdGroupId = adGroupId;
            // to ensure "keywordText" is required (not null)
            if (keywordText == null)
            {
                throw new ArgumentNullException("keywordText is a required property for SponsoredProductsCreateDraftNegativeKeyword and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsCreateDraftNegativeKeyword {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsCreateDraftNegativeKeyword);
        }

        /// <summary>
        /// Returns true if SponsoredProductsCreateDraftNegativeKeyword instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsCreateDraftNegativeKeyword to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsCreateDraftNegativeKeyword input)
        {
            if (input == null)
            {
                return false;
