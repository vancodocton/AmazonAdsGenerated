...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsCreateGlobalNegativeKeyword")]
    public partial class SponsoredProductsCreateGlobalNegativeKeyword : IEquatable<SponsoredProductsCreateGlobalNegativeKeyword>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCreateGlobalNegativeKeyword" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsCreateGlobalNegativeKeyword() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCreateGlobalNegativeKeyword" /> class.
        /// </summary>
        ...
        public SponsoredProductsCreateGlobalNegativeKeyword(string campaignId = default(string), SponsoredProductsCreateOrUpdateNegativeMatchType matchType = default(SponsoredProductsCreateOrUpdateNegativeMatchType), string name = default(string), SponsoredProductsCreateOrUpdateGlobalEntityState state = default(SponsoredProductsCreateOrUpdateGlobalEntityState), string adGroupId = default(string), SponsoredProductsGlobalNegativeKeywordText keywordText = default(SponsoredProductsGlobalNegativeKeywordText))
        {
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsCreateGlobalNegativeKeyword and cannot be null");
            }
            ...
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for SponsoredProductsCreateGlobalNegativeKeyword and cannot be null");
            }
            this.State = state;
            // to ensure "adGroupId" is required (not null)
            if (adGroupId == null)
            {
                throw new ArgumentNullException("adGroupId is a required property for SponsoredProductsCreateGlobalNegativeKeyword and cannot be null");
            }
            this.AdGroupId = adGroupId;
            // to ensure "keywordText" is required (not null)
            if (keywordText == null)
            {
                throw new ArgumentNullException("keywordText is a required property for SponsoredProductsCreateGlobalNegativeKeyword and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsCreateGlobalNegativeKeyword {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsCreateGlobalNegativeKeyword);
        }

        /// <summary>
        /// Returns true if SponsoredProductsCreateGlobalNegativeKeyword instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsCreateGlobalNegativeKeyword to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsCreateGlobalNegativeKeyword input)
        {
            if (input == null)
            {
                return false;
