...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsCampaign")]
    public partial class SponsoredProductsCampaign : IEquatable<SponsoredProductsCampaign>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCampaign" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsCampaign() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCampaign" /> class.
        /// </summary>
        ...
        /// <param name="startDate">The format of the date is YYYY-MM-DD. (required).</param>
        ...
        public SponsoredProductsCampaign(string portfolioId = default(string), DateTime? endDate = default(DateTime?), string campaignId = default(string), string name = default(string), SponsoredProductsTargetingType targetingType = default(SponsoredProductsTargetingType), SponsoredProductsEntityState state = default(SponsoredProductsEntityState), SponsoredProductsDynamicBidding dynamicBidding = default(SponsoredProductsDynamicBidding), DateTime startDate = default(DateTime), SponsoredProductsBudget budget = default(SponsoredProductsBudget), Dictionary<string, string> tags = default(Dictionary<string, string>), SponsoredProductsCampaignExtendedData extendedData = default(SponsoredProductsCampaignExtendedData))
        {
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsCampaign and cannot be null");
            }
            this.CampaignId = campaignId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SponsoredProductsCampaign and cannot be null");
            }
            this.Name = name;
            ...
            if (budget == null)
            {
                throw new ArgumentNullException("budget is a required property for SponsoredProductsCampaign and cannot be null");
            }
            this.Budget = budget;
        ...
        public SponsoredProductsBudget Budget { get; set; }
        ...
        public SponsoredProductsCampaignExtendedData ExtendedData { get; set; }
        ...
        {
            return this.Equals(input as SponsoredProductsCampaign);
        }

        /// <summary>
        /// Returns true if SponsoredProductsCampaign instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsCampaign input)
        {
            if (input == null)
            {
                return false;
