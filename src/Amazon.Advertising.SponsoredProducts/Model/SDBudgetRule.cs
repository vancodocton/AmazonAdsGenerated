...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// SDBudgetRule
    /// </summary>
    [DataContract(Name = "SDBudgetRule")]
    public partial class SDBudgetRule : IEquatable<SDBudgetRule>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SDBudgetRule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SDBudgetRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SDBudgetRule" /> class.
        /// </summary>
        ...
        public SDBudgetRule(State? ruleState = default(State?), decimal lastUpdatedDate = default(decimal), decimal createdDate = default(decimal), SDBudgetRuleDetails ruleDetails = default(SDBudgetRuleDetails), string ruleId = default(string), string ruleStatus = default(string))
        {
            // to ensure "ruleId" is required (not null)
            if (ruleId == null)
            {
                throw new ArgumentNullException("ruleId is a required property for SDBudgetRule and cannot be null");
            }
            this.RuleId = ruleId;
        ...
        public SDBudgetRuleDetails RuleDetails { get; set; }
        ...
        {
            return this.Equals(input as SDBudgetRule);
        }

        /// <summary>
        /// Returns true if SDBudgetRule instances are equal
        /// </summary>
        /// <param name="input">Instance of SDBudgetRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SDBudgetRule input)
        {
            if (input == null)
            {
                return false;
