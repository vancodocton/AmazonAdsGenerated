...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent : IEquatable<SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent" /> class.
        /// </summary>
        ...
        public SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent(int maxResults = default(int), string nextToken = default(string), SponsoredProductsObjectIdFilter adGroupIdFilter = default(SponsoredProductsObjectIdFilter), bool includeExtendedDataFields = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsGlobalAdGroupsRequestContent input)
        {
            if (input == null)
            {
                return false;
