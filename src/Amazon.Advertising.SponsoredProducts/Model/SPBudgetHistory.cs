...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// SPBudgetHistory
    /// </summary>
    [DataContract(Name = "SPBudgetHistory")]
    public partial class SPBudgetHistory : IEquatable<SPBudgetHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SPBudgetHistory" /> class.
        /// </summary>
        ...
        public SPBudgetHistory(string nextToken = default(string), List<SPRuleBasedBudget> history = default(List<SPRuleBasedBudget>))
        {
        ...
        public List<SPRuleBasedBudget> History { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SPBudgetHistory {\n");
        ...
        {
            return this.Equals(input as SPBudgetHistory);
        }

        /// <summary>
        /// Returns true if SPBudgetHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of SPBudgetHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SPBudgetHistory input)
        {
            if (input == null)
            {
                return false;
