...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsGlobalNegativeKeyword")]
    public partial class SponsoredProductsGlobalNegativeKeyword : IEquatable<SponsoredProductsGlobalNegativeKeyword>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsGlobalNegativeKeyword" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsGlobalNegativeKeyword() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsGlobalNegativeKeyword" /> class.
        /// </summary>
        ...
        public SponsoredProductsGlobalNegativeKeyword(string keywordId = default(string), string campaignId = default(string), SponsoredProductsNegativeMatchType matchType = default(SponsoredProductsNegativeMatchType), string name = default(string), SponsoredProductsGlobalEntityState state = default(SponsoredProductsGlobalEntityState), string adGroupId = default(string), SponsoredProductsGlobalNegativeKeywordText keywordText = default(SponsoredProductsGlobalNegativeKeywordText), SponsoredProductsGlobalNegativeKeywordExtendedData extendedData = default(SponsoredProductsGlobalNegativeKeywordExtendedData))
        {
            // to ensure "keywordId" is required (not null)
            if (keywordId == null)
            {
                throw new ArgumentNullException("keywordId is a required property for SponsoredProductsGlobalNegativeKeyword and cannot be null");
            }
            this.KeywordId = keywordId;
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsGlobalNegativeKeyword and cannot be null");
            }
            ...
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for SponsoredProductsGlobalNegativeKeyword and cannot be null");
            }
            this.State = state;
            // to ensure "adGroupId" is required (not null)
            if (adGroupId == null)
            {
                throw new ArgumentNullException("adGroupId is a required property for SponsoredProductsGlobalNegativeKeyword and cannot be null");
            }
            this.AdGroupId = adGroupId;
            // to ensure "keywordText" is required (not null)
            if (keywordText == null)
            {
                throw new ArgumentNullException("keywordText is a required property for SponsoredProductsGlobalNegativeKeyword and cannot be null");
            }
        ...
        public SponsoredProductsGlobalNegativeKeywordExtendedData ExtendedData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsGlobalNegativeKeyword {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsGlobalNegativeKeyword);
        }

        /// <summary>
        /// Returns true if SponsoredProductsGlobalNegativeKeyword instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsGlobalNegativeKeyword to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsGlobalNegativeKeyword input)
        {
            if (input == null)
            {
                return false;
