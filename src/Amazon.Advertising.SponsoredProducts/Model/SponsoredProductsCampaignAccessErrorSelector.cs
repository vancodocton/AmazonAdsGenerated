...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsCampaignAccessErrorSelector")]
    public partial class SponsoredProductsCampaignAccessErrorSelector : IEquatable<SponsoredProductsCampaignAccessErrorSelector>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCampaignAccessErrorSelector" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SponsoredProductsCampaignAccessErrorSelector);
        }

        /// <summary>
        /// Returns true if SponsoredProductsCampaignAccessErrorSelector instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsCampaignAccessErrorSelector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsCampaignAccessErrorSelector input)
        {
            if (input == null)
            {
                return false;
