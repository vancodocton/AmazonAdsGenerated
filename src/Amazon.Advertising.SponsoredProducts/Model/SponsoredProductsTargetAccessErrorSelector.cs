...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsTargetAccessErrorSelector")]
    public partial class SponsoredProductsTargetAccessErrorSelector : IEquatable<SponsoredProductsTargetAccessErrorSelector>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsTargetAccessErrorSelector" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SponsoredProductsTargetAccessErrorSelector);
        }

        /// <summary>
        /// Returns true if SponsoredProductsTargetAccessErrorSelector instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsTargetAccessErrorSelector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsTargetAccessErrorSelector input)
        {
            if (input == null)
            {
                return false;
