...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent : IEquatable<SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent" /> class.
        /// </summary>
        ...
        public SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent(SponsoredProductsObjectIdFilter campaignIdFilter = default(SponsoredProductsObjectIdFilter), SponsoredProductsReducedObjectIdFilter portfolioIdFilter = default(SponsoredProductsReducedObjectIdFilter), int maxResults = default(int), string nextToken = default(string), bool includeExtendedDataFields = default(bool), SponsoredProductsNameFilter nameFilter = default(SponsoredProductsNameFilter))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsDraftCampaignsRequestContent input)
        {
            if (input == null)
            {
                return false;
