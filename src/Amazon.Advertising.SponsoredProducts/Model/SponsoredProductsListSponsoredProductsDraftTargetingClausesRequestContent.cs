...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent : IEquatable<SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent" /> class.
        /// </summary>
        ...
        public SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent(SponsoredProductsReducedObjectIdFilter campaignIdFilter = default(SponsoredProductsReducedObjectIdFilter), SponsoredProductsExpressionTypeFilter expressionTypeFilter = default(SponsoredProductsExpressionTypeFilter), int maxResults = default(int), string nextToken = default(string), SponsoredProductsObjectIdFilter targetIdFilter = default(SponsoredProductsObjectIdFilter), SponsoredProductsAsinFilter asinFilter = default(SponsoredProductsAsinFilter), SponsoredProductsReducedObjectIdFilter adGroupIdFilter = default(SponsoredProductsReducedObjectIdFilter), bool includeExtendedDataFields = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsDraftTargetingClausesRequestContent input)
        {
            if (input == null)
            {
                return false;
