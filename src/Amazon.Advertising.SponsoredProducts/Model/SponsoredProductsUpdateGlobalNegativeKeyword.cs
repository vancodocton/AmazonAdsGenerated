...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsUpdateGlobalNegativeKeyword")]
    public partial class SponsoredProductsUpdateGlobalNegativeKeyword : IEquatable<SponsoredProductsUpdateGlobalNegativeKeyword>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsUpdateGlobalNegativeKeyword" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsUpdateGlobalNegativeKeyword() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsUpdateGlobalNegativeKeyword" /> class.
        /// </summary>
        ...
        public SponsoredProductsUpdateGlobalNegativeKeyword(string keywordId = default(string), string name = default(string), SponsoredProductsCreateOrUpdateGlobalEntityState state = default(SponsoredProductsCreateOrUpdateGlobalEntityState), SponsoredProductsGlobalNegativeKeywordText keywordText = default(SponsoredProductsGlobalNegativeKeywordText))
        {
            // to ensure "keywordId" is required (not null)
            if (keywordId == null)
            {
                throw new ArgumentNullException("keywordId is a required property for SponsoredProductsUpdateGlobalNegativeKeyword and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsUpdateGlobalNegativeKeyword {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsUpdateGlobalNegativeKeyword);
        }

        /// <summary>
        /// Returns true if SponsoredProductsUpdateGlobalNegativeKeyword instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsUpdateGlobalNegativeKeyword to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsUpdateGlobalNegativeKeyword input)
        {
            if (input == null)
            {
                return false;
