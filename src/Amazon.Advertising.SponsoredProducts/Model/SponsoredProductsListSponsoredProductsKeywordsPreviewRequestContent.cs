...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent : IEquatable<SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent" /> class.
        /// </summary>
        ...
        /// <param name="locale">Restricts results to keywords associated with locale.</param>
        /// <param name="keywordTextFilter">keywordTextFilter.</param>
        /// <param name="keywordIdFilter">keywordIdFilter.</param>
        /// <param name="matchTypeFilter">Only the keyword with match type that is in this list will be listed.</param>
        public SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent(SponsoredProductsReducedObjectIdFilter campaignIdFilter = default(SponsoredProductsReducedObjectIdFilter), SponsoredProductsEntityStateFilter stateFilter = default(SponsoredProductsEntityStateFilter), int maxResults = default(int), string nextToken = default(string), SponsoredProductsReducedObjectIdFilter adGroupIdFilter = default(SponsoredProductsReducedObjectIdFilter), bool includeExtendedDataFields = default(bool), string locale = default(string), SponsoredProductsKeywordTextFilter keywordTextFilter = default(SponsoredProductsKeywordTextFilter), SponsoredProductsObjectIdFilter keywordIdFilter = default(SponsoredProductsObjectIdFilter), List<SponsoredProductsMatchType> matchTypeFilter = default(List<SponsoredProductsMatchType>))
        {
        ...
        /// </summary>
        /// <value>Restricts results to keywords associated with locale</value>
        ...
        /// </summary>
        /// <value>Only the keyword with match type that is in this list will be listed</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsKeywordsPreviewRequestContent input)
        {
            if (input == null)
            {
                return false;
