...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftAdGroupExtendedData")]
    public partial class SponsoredProductsDraftAdGroupExtendedData : IEquatable<SponsoredProductsDraftAdGroupExtendedData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftAdGroupExtendedData" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftAdGroupExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsAdGroupServingStatus? servingStatus = default(SponsoredProductsAdGroupServingStatus?), DateTime creationDateTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftAdGroupExtendedData {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftAdGroupExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftAdGroupExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftAdGroupExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftAdGroupExtendedData input)
        {
            if (input == null)
            {
                return false;
