...
{
    /// <summary>
    /// RankedTargetWithThemedBidsBidInfoInner
    /// </summary>
    [DataContract(Name = "RankedTargetWithThemedBids_bidInfo_inner")]
    public partial class RankedTargetWithThemedBidsBidInfoInner : IEquatable<RankedTargetWithThemedBidsBidInfoInner>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RankedTargetWithThemedBidsBidInfoInner" /> class.
        /// </summary>
        ...
        /// <param name="theme">The theme of the bid recommendation. The default theme is CONVERSION_OPPORTUNITIES..</param>
        /// <param name="bid">The bid value for the keyword. The default value will be the suggested bid..</param>
        public RankedTargetWithThemedBidsBidInfoInner(BidValues suggestedBid = default(BidValues), MatchTypeEnum? matchType = default(MatchTypeEnum?), decimal rank = default(decimal), string theme = default(string), decimal bid = default(decimal))
        {
        ...
        public BidValues SuggestedBid { get; set; }
        ...
        /// </summary>
        /// <value>The theme of the bid recommendation. The default theme is CONVERSION_OPPORTUNITIES.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RankedTargetWithThemedBidsBidInfoInner {\n");
        ...
        {
            return this.Equals(input as RankedTargetWithThemedBidsBidInfoInner);
        }

        /// <summary>
        /// Returns true if RankedTargetWithThemedBidsBidInfoInner instances are equal
        /// </summary>
        /// <param name="input">Instance of RankedTargetWithThemedBidsBidInfoInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankedTargetWithThemedBidsBidInfoInner input)
        {
            if (input == null)
            {
                return false;
