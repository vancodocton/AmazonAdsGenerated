...
{
    /// <summary>
    /// RecKeywordTargetBidInfoInner
    /// </summary>
    [DataContract(Name = "RecKeywordTarget_bidInfo_inner")]
    public partial class RecKeywordTargetBidInfoInner : IEquatable<RecKeywordTargetBidInfoInner>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RecKeywordTargetBidInfoInner" /> class.
        /// </summary>
        ...
        public RecKeywordTargetBidInfoInner(BidSuggestion suggestedBid = default(BidSuggestion), MatchTypeEnum? matchType = default(MatchTypeEnum?), decimal rank = default(decimal), decimal bid = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecKeywordTargetBidInfoInner {\n");
        ...
        {
            return this.Equals(input as RecKeywordTargetBidInfoInner);
        }

        /// <summary>
        /// Returns true if RecKeywordTargetBidInfoInner instances are equal
        /// </summary>
        /// <param name="input">Instance of RecKeywordTargetBidInfoInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecKeywordTargetBidInfoInner input)
        {
            if (input == null)
            {
                return false;
