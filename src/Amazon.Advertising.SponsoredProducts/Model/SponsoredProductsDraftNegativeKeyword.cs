...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftNegativeKeyword")]
    public partial class SponsoredProductsDraftNegativeKeyword : IEquatable<SponsoredProductsDraftNegativeKeyword>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftNegativeKeyword" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsDraftNegativeKeyword() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftNegativeKeyword" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftNegativeKeyword(string keywordId = default(string), string nativeLanguageKeyword = default(string), string nativeLanguageLocale = default(string), string campaignId = default(string), SponsoredProductsNegativeMatchType matchType = default(SponsoredProductsNegativeMatchType), string adGroupId = default(string), string keywordText = default(string), SponsoredProductsDraftNegativeKeywordExtendedData extendedData = default(SponsoredProductsDraftNegativeKeywordExtendedData))
        {
            // to ensure "keywordId" is required (not null)
            if (keywordId == null)
            {
                throw new ArgumentNullException("keywordId is a required property for SponsoredProductsDraftNegativeKeyword and cannot be null");
            }
            this.KeywordId = keywordId;
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsDraftNegativeKeyword and cannot be null");
            }
            ...
            if (adGroupId == null)
            {
                throw new ArgumentNullException("adGroupId is a required property for SponsoredProductsDraftNegativeKeyword and cannot be null");
            }
            this.AdGroupId = adGroupId;
            // to ensure "keywordText" is required (not null)
            if (keywordText == null)
            {
                throw new ArgumentNullException("keywordText is a required property for SponsoredProductsDraftNegativeKeyword and cannot be null");
            }
        ...
        public SponsoredProductsDraftNegativeKeywordExtendedData ExtendedData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftNegativeKeyword {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftNegativeKeyword);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftNegativeKeyword instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftNegativeKeyword to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftNegativeKeyword input)
        {
            if (input == null)
            {
                return false;
