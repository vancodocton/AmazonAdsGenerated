...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RankedKeywordTargetsForAsinsRequest")]
    public partial class RankedKeywordTargetsForAsinsRequest : IEquatable<RankedKeywordTargetsForAsinsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The bid recommendations returned will depend on the bidding strategy. &lt;br&gt; LEGACY_FOR_SALES - Dynamic Bids (Down only) &lt;br&gt; AUTO_FOR_SALES - Dynamic Bids (Up or down) &lt;br&gt; MANUAL - Fixed Bids</value>
        ...
        /// </summary>
        /// <value>The bid recommendations returned will depend on the bidding strategy. &lt;br&gt; LEGACY_FOR_SALES - Dynamic Bids (Down only) &lt;br&gt; AUTO_FOR_SALES - Dynamic Bids (Up or down) &lt;br&gt; MANUAL - Fixed Bids</value>
        [DataMember(Name = "biddingStrategy", EmitDefaultValue = false)]
        public BiddingStrategyEnum? BiddingStrategy { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RankedKeywordTargetsForAsinsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RankedKeywordTargetsForAsinsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RankedKeywordTargetsForAsinsRequest" /> class.
        /// </summary>
        /// <param name="asins">An array list of Asins (required).</param>
        /// <param name="biddingStrategy">The bid recommendations returned will depend on the bidding strategy. &lt;br&gt; LEGACY_FOR_SALES - Dynamic Bids (Down only) &lt;br&gt; AUTO_FOR_SALES - Dynamic Bids (Up or down) &lt;br&gt; MANUAL - Fixed Bids (default to BiddingStrategyEnum.LEGACYFORSALES).</param>
        ...
        public RankedKeywordTargetsForAsinsRequest(List<string> asins = default(List<string>), BiddingStrategyEnum? biddingStrategy = BiddingStrategyEnum.LEGACYFORSALES, RecommendationTypeEnum recommendationType = default(RecommendationTypeEnum), bool bidsEnabled = true, decimal maxRecommendations = 200M, SortDimensionEnum? sortDimension = default(SortDimensionEnum?), LocaleEnum? locale = default(LocaleEnum?))
        {
            // to ensure "asins" is required (not null)
            if (asins == null)
            {
                throw new ArgumentNullException("asins is a required property for RankedKeywordTargetsForAsinsRequest and cannot be null");
            }
            this.Asins = asins;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BiddingStrategy: ").Append(BiddingStrategy).Append("\n");
        ...
        {
            return this.Equals(input as RankedKeywordTargetsForAsinsRequest);
        }

        /// <summary>
        /// Returns true if RankedKeywordTargetsForAsinsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RankedKeywordTargetsForAsinsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankedKeywordTargetsForAsinsRequest input)
        {
            if (input == null)
            {
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.BiddingStrategy.GetHashCode();
