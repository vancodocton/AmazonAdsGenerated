...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsAdGroupAccessErrorSelector")]
    public partial class SponsoredProductsAdGroupAccessErrorSelector : IEquatable<SponsoredProductsAdGroupAccessErrorSelector>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsAdGroupAccessErrorSelector" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SponsoredProductsAdGroupAccessErrorSelector);
        }

        /// <summary>
        /// Returns true if SponsoredProductsAdGroupAccessErrorSelector instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsAdGroupAccessErrorSelector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsAdGroupAccessErrorSelector input)
        {
            if (input == null)
            {
                return false;
