...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsCampaignNegativeKeywordMutationErrorSelector")]
    public partial class SponsoredProductsCampaignNegativeKeywordMutationErrorSelector : IEquatable<SponsoredProductsCampaignNegativeKeywordMutationErrorSelector>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCampaignNegativeKeywordMutationErrorSelector" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SponsoredProductsCampaignNegativeKeywordMutationErrorSelector);
        }

        /// <summary>
        /// Returns true if SponsoredProductsCampaignNegativeKeywordMutationErrorSelector instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsCampaignNegativeKeywordMutationErrorSelector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsCampaignNegativeKeywordMutationErrorSelector input)
        {
            if (input == null)
            {
                return false;
