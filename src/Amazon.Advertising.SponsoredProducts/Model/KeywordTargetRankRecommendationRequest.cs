...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KeywordTargetRankRecommendationRequest")]
    public partial class KeywordTargetRankRecommendationRequest : IEquatable<KeywordTargetRankRecommendationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KeywordTargetRankRecommendationRequest" /> class.
        /// </summary>
        /// <param name="targets">A list of targets that need to be ranked.</param>
        ...
        public KeywordTargetRankRecommendationRequest(List<KeywordTarget> targets = default(List<KeywordTarget>), decimal maxRecommendations = 200M, SortDimensionEnum? sortDimension = default(SortDimensionEnum?), LocaleEnum? locale = default(LocaleEnum?))
        {
        ...
        /// </summary>
        /// <value>A list of targets that need to be ranked</value>
        [DataMember(Name = "targets", EmitDefaultValue = false)]
        public List<KeywordTarget> Targets { get; set; }
        ...
        {
            return this.Equals(input as KeywordTargetRankRecommendationRequest);
        }

        /// <summary>
        /// Returns true if KeywordTargetRankRecommendationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KeywordTargetRankRecommendationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeywordTargetRankRecommendationRequest input)
        {
            if (input == null)
            {
                return false;
