...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent : IEquatable<SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent" /> class.
        /// </summary>
        ...
        public SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent(int maxResults = default(int), string nextToken = default(string), SponsoredProductsObjectIdFilter adIdFilter = default(SponsoredProductsObjectIdFilter), bool includeExtendedDataFields = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsGlobalProductAdsRequestContent input)
        {
            if (input == null)
            {
                return false;
