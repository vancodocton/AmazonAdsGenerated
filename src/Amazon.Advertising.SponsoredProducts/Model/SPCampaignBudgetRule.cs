...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SPCampaignBudgetRule")]
    public partial class SPCampaignBudgetRule : IEquatable<SPCampaignBudgetRule>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SPCampaignBudgetRule" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SPCampaignBudgetRule() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SPCampaignBudgetRule" /> class.
        /// </summary>
        ...
        public SPCampaignBudgetRule(State? ruleState = default(State?), decimal lastUpdatedDate = default(decimal), decimal createdDate = default(decimal), SPBudgetRuleDetails ruleDetails = default(SPBudgetRuleDetails), string ruleId = default(string), string ruleStatus = default(string))
        {
            // to ensure "ruleId" is required (not null)
            if (ruleId == null)
            {
                throw new ArgumentNullException("ruleId is a required property for SPCampaignBudgetRule and cannot be null");
            }
            this.RuleId = ruleId;
        ...
        public SPBudgetRuleDetails RuleDetails { get; set; }
        ...
        {
            return this.Equals(input as SPCampaignBudgetRule);
        }

        /// <summary>
        /// Returns true if SPCampaignBudgetRule instances are equal
        /// </summary>
        /// <param name="input">Instance of SPCampaignBudgetRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SPCampaignBudgetRule input)
        {
            if (input == null)
            {
                return false;
