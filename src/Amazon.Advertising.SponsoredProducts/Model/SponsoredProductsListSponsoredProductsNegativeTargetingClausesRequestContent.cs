...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent : IEquatable<SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent" /> class.
        /// </summary>
        ...
        public SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent(SponsoredProductsObjectIdFilter negativeTargetIdFilter = default(SponsoredProductsObjectIdFilter), SponsoredProductsReducedObjectIdFilter campaignIdFilter = default(SponsoredProductsReducedObjectIdFilter), SponsoredProductsEntityStateFilter stateFilter = default(SponsoredProductsEntityStateFilter), int maxResults = default(int), string nextToken = default(string), SponsoredProductsAsinFilter asinFilter = default(SponsoredProductsAsinFilter), SponsoredProductsReducedObjectIdFilter adGroupIdFilter = default(SponsoredProductsReducedObjectIdFilter), bool includeExtendedDataFields = default(bool))
        {
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent input)
        {
            if (input == null)
            {
                return false;
