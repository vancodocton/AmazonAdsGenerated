...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SBGetAssociatedCampaignsResponse")]
    public partial class SBGetAssociatedCampaignsResponse : IEquatable<SBGetAssociatedCampaignsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SBGetAssociatedCampaignsResponse" /> class.
        /// </summary>
        ...
        public SBGetAssociatedCampaignsResponse(List<AssociatedCampaign> associatedCampaigns = default(List<AssociatedCampaign>), string nextToken = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SBGetAssociatedCampaignsResponse {\n");
        ...
        {
            return this.Equals(input as SBGetAssociatedCampaignsResponse);
        }

        /// <summary>
        /// Returns true if SBGetAssociatedCampaignsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SBGetAssociatedCampaignsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SBGetAssociatedCampaignsResponse input)
        {
            if (input == null)
            {
                return false;
