...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent : IEquatable<SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent" /> class.
        /// </summary>
        ...
        /// <param name="adIdFilter">adIdFilter.</param>
        ...
        public SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent(SponsoredProductsReducedObjectIdFilter campaignIdFilter = default(SponsoredProductsReducedObjectIdFilter), int maxResults = default(int), string nextToken = default(string), SponsoredProductsObjectIdFilter adIdFilter = default(SponsoredProductsObjectIdFilter), SponsoredProductsReducedObjectIdFilter adGroupIdFilter = default(SponsoredProductsReducedObjectIdFilter), bool includeExtendedDataFields = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "adIdFilter", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsDraftProductAdsRequestContent input)
        {
            if (input == null)
            {
                return false;
