...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteSPCampaignOptimizationRuleResponse")]
    public partial class DeleteSPCampaignOptimizationRuleResponse : IEquatable<DeleteSPCampaignOptimizationRuleResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSPCampaignOptimizationRuleResponse" /> class.
        /// </summary>
        ...
        public DeleteSPCampaignOptimizationRuleResponse(string campaignOptimizationId = default(string), string code = default(string), string details = default(string))
        {
        ...
        {
            return this.Equals(input as DeleteSPCampaignOptimizationRuleResponse);
        }

        /// <summary>
        /// Returns true if DeleteSPCampaignOptimizationRuleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteSPCampaignOptimizationRuleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteSPCampaignOptimizationRuleResponse input)
        {
            if (input == null)
            {
                return false;
