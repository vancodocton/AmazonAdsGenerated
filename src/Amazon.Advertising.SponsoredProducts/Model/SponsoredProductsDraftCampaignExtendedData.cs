...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftCampaignExtendedData")]
    public partial class SponsoredProductsDraftCampaignExtendedData : IEquatable<SponsoredProductsDraftCampaignExtendedData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftCampaignExtendedData" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftCampaignExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsCampaignServingStatus? servingStatus = default(SponsoredProductsCampaignServingStatus?), DateTime creationDateTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftCampaignExtendedData {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftCampaignExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftCampaignExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftCampaignExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftCampaignExtendedData input)
        {
            if (input == null)
            {
                return false;
