...
{
    /// <summary>
    /// RankedTargetResponseKeywordTargetListInner
    /// </summary>
    [DataContract(Name = "RankedTargetResponse_keywordTargetList_inner")]
    public partial class RankedTargetResponseKeywordTargetListInner : IEquatable<RankedTargetResponseKeywordTargetListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankedTargetResponseKeywordTargetListInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RankedTargetResponseKeywordTargetListInner {\n");
        ...
        {
            return this.Equals(input as RankedTargetResponseKeywordTargetListInner);
        }

        /// <summary>
        /// Returns true if RankedTargetResponseKeywordTargetListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of RankedTargetResponseKeywordTargetListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankedTargetResponseKeywordTargetListInner input)
        {
            if (input == null)
            {
                return false;
