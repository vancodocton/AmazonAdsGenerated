...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftNegativeTargetingClauseExtendedData")]
    public partial class SponsoredProductsDraftNegativeTargetingClauseExtendedData : IEquatable<SponsoredProductsDraftNegativeTargetingClauseExtendedData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftNegativeTargetingClauseExtendedData" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftNegativeTargetingClauseExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsKeywordServingStatus? servingStatus = default(SponsoredProductsKeywordServingStatus?), DateTime creationDateTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftNegativeTargetingClauseExtendedData {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftNegativeTargetingClauseExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftNegativeTargetingClauseExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftNegativeTargetingClauseExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftNegativeTargetingClauseExtendedData input)
        {
            if (input == null)
            {
                return false;
