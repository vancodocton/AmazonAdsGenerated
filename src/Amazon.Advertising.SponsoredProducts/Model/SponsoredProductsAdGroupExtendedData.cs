...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsAdGroupExtendedData")]
    public partial class SponsoredProductsAdGroupExtendedData : IEquatable<SponsoredProductsAdGroupExtendedData>, IValidatableObject
    {
        ...
        public SponsoredProductsAdGroupServingStatus? ServingStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsAdGroupExtendedData" /> class.
        /// </summary>
        /// <param name="lastUpdateDateTime">Last updated date in ISO 8601..</param>
        /// <param name="servingStatus">servingStatus.</param>
        /// <param name="servingStatusDetails">The serving status reasons of the AdGroup.</param>
        /// <param name="creationDateTime">Creation date in ISO 8601..</param>
        public SponsoredProductsAdGroupExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsAdGroupServingStatus? servingStatus = default(SponsoredProductsAdGroupServingStatus?), List<SponsoredProductsAdGroupServingStatusDetail> servingStatusDetails = default(List<SponsoredProductsAdGroupServingStatusDetail>), DateTime creationDateTime = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The serving status reasons of the AdGroup</value>
        [DataMember(Name = "servingStatusDetails", EmitDefaultValue = false)]
        public List<SponsoredProductsAdGroupServingStatusDetail> ServingStatusDetails { get; set; }
        ...
        {
            return this.Equals(input as SponsoredProductsAdGroupExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsAdGroupExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsAdGroupExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsAdGroupExtendedData input)
        {
            if (input == null)
            {
                return false;
