...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsProductAdAccessErrorSelector")]
    public partial class SponsoredProductsProductAdAccessErrorSelector : IEquatable<SponsoredProductsProductAdAccessErrorSelector>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsProductAdAccessErrorSelector" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SponsoredProductsProductAdAccessErrorSelector);
        }

        /// <summary>
        /// Returns true if SponsoredProductsProductAdAccessErrorSelector instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsProductAdAccessErrorSelector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsProductAdAccessErrorSelector input)
        {
            if (input == null)
            {
                return false;
