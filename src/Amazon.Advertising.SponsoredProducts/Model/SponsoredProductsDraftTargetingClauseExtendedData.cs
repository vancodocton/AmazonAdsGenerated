...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftTargetingClauseExtendedData")]
    public partial class SponsoredProductsDraftTargetingClauseExtendedData : IEquatable<SponsoredProductsDraftTargetingClauseExtendedData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftTargetingClauseExtendedData" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftTargetingClauseExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsKeywordServingStatus? servingStatus = default(SponsoredProductsKeywordServingStatus?), DateTime creationDateTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftTargetingClauseExtendedData {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftTargetingClauseExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftTargetingClauseExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftTargetingClauseExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftTargetingClauseExtendedData input)
        {
            if (input == null)
            {
                return false;
