...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsCampaignExtendedData")]
    public partial class SponsoredProductsCampaignExtendedData : IEquatable<SponsoredProductsCampaignExtendedData>, IValidatableObject
    {
        ...
        public SponsoredProductsCampaignServingStatus? ServingStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCampaignExtendedData" /> class.
        /// </summary>
        /// <param name="lastUpdateDateTime">Last updated date in ISO 8601..</param>
        /// <param name="servingStatus">servingStatus.</param>
        /// <param name="servingStatusDetails">The serving status reasons of the Campaign.</param>
        /// <param name="creationDateTime">Creation date in ISO 8601..</param>
        public SponsoredProductsCampaignExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsCampaignServingStatus? servingStatus = default(SponsoredProductsCampaignServingStatus?), List<SponsoredProductsCampaignServingStatusDetail> servingStatusDetails = default(List<SponsoredProductsCampaignServingStatusDetail>), DateTime creationDateTime = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The serving status reasons of the Campaign</value>
        [DataMember(Name = "servingStatusDetails", EmitDefaultValue = false)]
        public List<SponsoredProductsCampaignServingStatusDetail> ServingStatusDetails { get; set; }
        ...
        {
            return this.Equals(input as SponsoredProductsCampaignExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsCampaignExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsCampaignExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsCampaignExtendedData input)
        {
            if (input == null)
            {
                return false;
