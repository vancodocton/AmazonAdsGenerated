...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftCampaignNegativeKeywordExtendedData")]
    public partial class SponsoredProductsDraftCampaignNegativeKeywordExtendedData : IEquatable<SponsoredProductsDraftCampaignNegativeKeywordExtendedData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftCampaignNegativeKeywordExtendedData" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftCampaignNegativeKeywordExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsKeywordServingStatus? servingStatus = default(SponsoredProductsKeywordServingStatus?), DateTime creationDateTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftCampaignNegativeKeywordExtendedData {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftCampaignNegativeKeywordExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftCampaignNegativeKeywordExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftCampaignNegativeKeywordExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftCampaignNegativeKeywordExtendedData input)
        {
            if (input == null)
            {
                return false;
