...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftKeywordExtendedData")]
    public partial class SponsoredProductsDraftKeywordExtendedData : IEquatable<SponsoredProductsDraftKeywordExtendedData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftKeywordExtendedData" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftKeywordExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsKeywordServingStatus? servingStatus = default(SponsoredProductsKeywordServingStatus?), DateTime creationDateTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftKeywordExtendedData {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftKeywordExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftKeywordExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftKeywordExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftKeywordExtendedData input)
        {
            if (input == null)
            {
                return false;
