...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent : IEquatable<SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent" /> class.
        /// </summary>
        ...
        public SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent(SponsoredProductsObjectIdFilter campaignNegativeKeywordIdFilter = default(SponsoredProductsObjectIdFilter), int maxResults = default(int), string nextToken = default(string), bool includeExtendedDataFields = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsGlobalCampaignNegativeKeywordsRequestContent input)
        {
            if (input == null)
            {
                return false;
