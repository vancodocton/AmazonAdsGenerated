...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem")]
    public partial class SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem : IEquatable<SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem" /> class.
        /// </summary>
        ...
        public SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem(SponsoredProductsGlobalCampaignNegativeKeyword campaignNegativeKeyword = default(SponsoredProductsGlobalCampaignNegativeKeyword), string campaignNegativeKeywordId = default(string), int index = default(int))
        {
            this.Index = index;
        ...
        public SponsoredProductsGlobalCampaignNegativeKeyword CampaignNegativeKeyword { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem);
        }

        /// <summary>
        /// Returns true if SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsGlobalCampaignNegativeKeywordSuccessResponseItem input)
        {
            if (input == null)
            {
                return false;
