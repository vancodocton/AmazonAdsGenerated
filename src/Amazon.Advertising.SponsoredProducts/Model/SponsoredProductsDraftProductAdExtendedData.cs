...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsDraftProductAdExtendedData")]
    public partial class SponsoredProductsDraftProductAdExtendedData : IEquatable<SponsoredProductsDraftProductAdExtendedData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsDraftProductAdExtendedData" /> class.
        /// </summary>
        ...
        public SponsoredProductsDraftProductAdExtendedData(DateTime lastUpdateDateTime = default(DateTime), SponsoredProductsAdServingStatus? servingStatus = default(SponsoredProductsAdServingStatus?), DateTime creationDateTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsDraftProductAdExtendedData {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsDraftProductAdExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsDraftProductAdExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsDraftProductAdExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsDraftProductAdExtendedData input)
        {
            if (input == null)
            {
                return false;
