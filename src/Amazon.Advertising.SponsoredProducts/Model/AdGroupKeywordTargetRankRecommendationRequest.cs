...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdGroupKeywordTargetRankRecommendationRequest")]
    public partial class AdGroupKeywordTargetRankRecommendationRequest : IEquatable<AdGroupKeywordTargetRankRecommendationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdGroupKeywordTargetRankRecommendationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdGroupKeywordTargetRankRecommendationRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdGroupKeywordTargetRankRecommendationRequest" /> class.
        /// </summary>
        ...
        public AdGroupKeywordTargetRankRecommendationRequest(string campaignId = default(string), RecommendationTypeEnum recommendationType = default(RecommendationTypeEnum), string adGroupId = default(string), decimal maxRecommendations = 200M, SortDimensionEnum? sortDimension = default(SortDimensionEnum?), LocaleEnum? locale = default(LocaleEnum?))
        {
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for AdGroupKeywordTargetRankRecommendationRequest and cannot be null");
            }
            ...
            if (adGroupId == null)
            {
                throw new ArgumentNullException("adGroupId is a required property for AdGroupKeywordTargetRankRecommendationRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as AdGroupKeywordTargetRankRecommendationRequest);
        }

        /// <summary>
        /// Returns true if AdGroupKeywordTargetRankRecommendationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AdGroupKeywordTargetRankRecommendationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdGroupKeywordTargetRankRecommendationRequest input)
        {
            if (input == null)
            {
                return false;
