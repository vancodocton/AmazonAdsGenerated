...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// ThemedBid
    /// </summary>
    [DataContract(Name = "ThemedBid")]
    public partial class ThemedBid : IEquatable<ThemedBid>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThemedBid" /> class.
        /// </summary>
        ...
        public ThemedBid(BidValues suggestedBid = default(BidValues), MatchTypeEnum? matchType = default(MatchTypeEnum?), decimal rank = default(decimal), string theme = default(string), decimal bid = default(decimal))
        {
        ...
        {
            return this.Equals(input as ThemedBid);
        }

        /// <summary>
        /// Returns true if ThemedBid instances are equal
        /// </summary>
        /// <param name="input">Instance of ThemedBid to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThemedBid input)
        {
            if (input == null)
            {
                return false;
