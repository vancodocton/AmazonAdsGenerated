...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Conversions")]
    public partial class Conversions : IEquatable<Conversions>, IValidatableObject
    {
        /// <summary>
        ...
        public Conversions(int lower = default(int), int upper = default(int))
        {
            this.Lower = lower;
            this.Upper = upper;
        }
        ...
        {
            return this.Equals(input as Conversions);
        }

        /// <summary>
        /// Returns true if Conversions instances are equal
        /// </summary>
        /// <param name="input">Instance of Conversions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Conversions input)
        {
            if (input == null)
            {
                return false;
