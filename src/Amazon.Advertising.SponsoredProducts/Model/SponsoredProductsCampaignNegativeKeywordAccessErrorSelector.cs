...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsCampaignNegativeKeywordAccessErrorSelector")]
    public partial class SponsoredProductsCampaignNegativeKeywordAccessErrorSelector : IEquatable<SponsoredProductsCampaignNegativeKeywordAccessErrorSelector>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCampaignNegativeKeywordAccessErrorSelector" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SponsoredProductsCampaignNegativeKeywordAccessErrorSelector);
        }

        /// <summary>
        /// Returns true if SponsoredProductsCampaignNegativeKeywordAccessErrorSelector instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsCampaignNegativeKeywordAccessErrorSelector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsCampaignNegativeKeywordAccessErrorSelector input)
        {
            if (input == null)
            {
                return false;
