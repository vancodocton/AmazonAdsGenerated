...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsNegativeKeyword")]
    public partial class SponsoredProductsNegativeKeyword : IEquatable<SponsoredProductsNegativeKeyword>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsNegativeKeyword" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsNegativeKeyword() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsNegativeKeyword" /> class.
        /// </summary>
        ...
        public SponsoredProductsNegativeKeyword(string keywordId = default(string), string nativeLanguageKeyword = default(string), string nativeLanguageLocale = default(string), string campaignId = default(string), SponsoredProductsNegativeMatchType matchType = default(SponsoredProductsNegativeMatchType), SponsoredProductsEntityState state = default(SponsoredProductsEntityState), string adGroupId = default(string), string keywordText = default(string), SponsoredProductsNegativeKeywordExtendedData extendedData = default(SponsoredProductsNegativeKeywordExtendedData))
        {
            // to ensure "keywordId" is required (not null)
            if (keywordId == null)
            {
                throw new ArgumentNullException("keywordId is a required property for SponsoredProductsNegativeKeyword and cannot be null");
            }
            this.KeywordId = keywordId;
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsNegativeKeyword and cannot be null");
            }
            ...
            if (adGroupId == null)
            {
                throw new ArgumentNullException("adGroupId is a required property for SponsoredProductsNegativeKeyword and cannot be null");
            }
            this.AdGroupId = adGroupId;
            // to ensure "keywordText" is required (not null)
            if (keywordText == null)
            {
                throw new ArgumentNullException("keywordText is a required property for SponsoredProductsNegativeKeyword and cannot be null");
            }
        ...
        public SponsoredProductsNegativeKeywordExtendedData ExtendedData { get; set; }
        ...
        {
            return this.Equals(input as SponsoredProductsNegativeKeyword);
        }

        /// <summary>
        /// Returns true if SponsoredProductsNegativeKeyword instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsNegativeKeyword to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsNegativeKeyword input)
        {
            if (input == null)
            {
                return false;
