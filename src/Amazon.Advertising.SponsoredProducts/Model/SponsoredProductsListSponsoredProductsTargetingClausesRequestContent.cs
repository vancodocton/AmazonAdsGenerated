...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsListSponsoredProductsTargetingClausesRequestContent")]
    public partial class SponsoredProductsListSponsoredProductsTargetingClausesRequestContent : IEquatable<SponsoredProductsListSponsoredProductsTargetingClausesRequestContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsListSponsoredProductsTargetingClausesRequestContent" /> class.
        /// </summary>
        ...
        public SponsoredProductsListSponsoredProductsTargetingClausesRequestContent(SponsoredProductsReducedObjectIdFilter campaignIdFilter = default(SponsoredProductsReducedObjectIdFilter), SponsoredProductsEntityStateFilter stateFilter = default(SponsoredProductsEntityStateFilter), SponsoredProductsExpressionTypeFilter expressionTypeFilter = default(SponsoredProductsExpressionTypeFilter), int maxResults = default(int), string nextToken = default(string), SponsoredProductsObjectIdFilter targetIdFilter = default(SponsoredProductsObjectIdFilter), SponsoredProductsAsinFilter asinFilter = default(SponsoredProductsAsinFilter), SponsoredProductsReducedObjectIdFilter adGroupIdFilter = default(SponsoredProductsReducedObjectIdFilter), bool includeExtendedDataFields = default(bool))
        {
        ...
        {
            return this.Equals(input as SponsoredProductsListSponsoredProductsTargetingClausesRequestContent);
        }

        /// <summary>
        /// Returns true if SponsoredProductsListSponsoredProductsTargetingClausesRequestContent instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsListSponsoredProductsTargetingClausesRequestContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsListSponsoredProductsTargetingClausesRequestContent input)
        {
            if (input == null)
            {
                return false;
