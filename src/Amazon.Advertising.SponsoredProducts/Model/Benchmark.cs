...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    public partial class Benchmark : IEquatable<Benchmark>, IValidatableObject
    {
        ...
        public Benchmark(Daily daily = default(Daily))
        {
            // to ensure "daily" is required (not null)
            if (daily == null)
            {
                throw new ArgumentNullException("daily is a required property for Benchmark and cannot be null");
            }
            this.Daily = daily;
        }
