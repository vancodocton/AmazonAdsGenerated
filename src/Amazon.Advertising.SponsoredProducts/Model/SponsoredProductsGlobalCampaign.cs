...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsGlobalCampaign")]
    public partial class SponsoredProductsGlobalCampaign : IEquatable<SponsoredProductsGlobalCampaign>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsGlobalCampaign" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsGlobalCampaign() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsGlobalCampaign" /> class.
        /// </summary>
        ...
        public SponsoredProductsGlobalCampaign(DateTime endDate = default(DateTime), string campaignId = default(string), List<string> applicableMarketplaces = default(List<string>), string name = default(string), SponsoredProductsTargetingType targetingType = default(SponsoredProductsTargetingType), SponsoredProductsGlobalEntityState state = default(SponsoredProductsGlobalEntityState), SponsoredProductsDynamicBidding dynamicBidding = default(SponsoredProductsDynamicBidding), DateTime startDate = default(DateTime), SponsoredProductsGlobalBudget budget = default(SponsoredProductsGlobalBudget), Dictionary<string, string> tags = default(Dictionary<string, string>), SponsoredProductsGlobalCampaignExtendedData extendedData = default(SponsoredProductsGlobalCampaignExtendedData))
        {
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsGlobalCampaign and cannot be null");
            }
            this.CampaignId = campaignId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SponsoredProductsGlobalCampaign and cannot be null");
            }
            this.Name = name;
            ...
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for SponsoredProductsGlobalCampaign and cannot be null");
            }
            this.State = state;
            // to ensure "budget" is required (not null)
            if (budget == null)
            {
                throw new ArgumentNullException("budget is a required property for SponsoredProductsGlobalCampaign and cannot be null");
            }
            this.Budget = budget;
        ...
        public SponsoredProductsDynamicBidding DynamicBidding { get; set; }
        ...
        public SponsoredProductsGlobalCampaignExtendedData ExtendedData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsGlobalCampaign {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsGlobalCampaign);
        }

        /// <summary>
        /// Returns true if SponsoredProductsGlobalCampaign instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsGlobalCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsGlobalCampaign input)
        {
            if (input == null)
            {
                return false;
