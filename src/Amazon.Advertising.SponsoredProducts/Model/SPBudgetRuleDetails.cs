...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SPBudgetRuleDetails")]
    public partial class SPBudgetRuleDetails : IEquatable<SPBudgetRuleDetails>, IValidatableObject
    {
        ...
        public SPRuleType? RuleType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SPBudgetRuleDetails" /> class.
        /// </summary>
        ...
        public SPBudgetRuleDetails(RuleDuration duration = default(RuleDuration), Recurrence recurrence = default(Recurrence), SPRuleType? ruleType = default(SPRuleType?), BudgetIncreaseBy budgetIncreaseBy = default(BudgetIncreaseBy), string name = default(string), PerformanceMeasureCondition performanceMeasureCondition = default(PerformanceMeasureCondition))
        {
        ...
        {
            return this.Equals(input as SPBudgetRuleDetails);
        }

        /// <summary>
        /// Returns true if SPBudgetRuleDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of SPBudgetRuleDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SPBudgetRuleDetails input)
        {
            if (input == null)
            {
                return false;
