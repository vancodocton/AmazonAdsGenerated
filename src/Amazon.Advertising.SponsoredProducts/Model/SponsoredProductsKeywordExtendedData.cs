...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsKeywordExtendedData")]
    public partial class SponsoredProductsKeywordExtendedData : IEquatable<SponsoredProductsKeywordExtendedData>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsKeywordExtendedData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SponsoredProductsKeywordExtendedData);
        }

        /// <summary>
        /// Returns true if SponsoredProductsKeywordExtendedData instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsKeywordExtendedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsKeywordExtendedData input)
        {
            if (input == null)
            {
                return false;
