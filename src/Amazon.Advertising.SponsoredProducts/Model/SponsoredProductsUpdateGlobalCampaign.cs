...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsUpdateGlobalCampaign")]
    public partial class SponsoredProductsUpdateGlobalCampaign : IEquatable<SponsoredProductsUpdateGlobalCampaign>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsUpdateGlobalCampaign" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsUpdateGlobalCampaign() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsUpdateGlobalCampaign" /> class.
        /// </summary>
        ...
        public SponsoredProductsUpdateGlobalCampaign(DateTime endDate = default(DateTime), string campaignId = default(string), string name = default(string), SponsoredProductsTargetingType? targetingType = default(SponsoredProductsTargetingType?), SponsoredProductsCreateOrUpdateGlobalEntityState state = default(SponsoredProductsCreateOrUpdateGlobalEntityState), SponsoredProductsCreateOrUpdateDynamicBidding dynamicBidding = default(SponsoredProductsCreateOrUpdateDynamicBidding), DateTime startDate = default(DateTime), SponsoredProductsGlobalBudget budget = default(SponsoredProductsGlobalBudget), Dictionary<string, string> tags = default(Dictionary<string, string>))
        {
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsUpdateGlobalCampaign and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsUpdateGlobalCampaign {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsUpdateGlobalCampaign);
        }

        /// <summary>
        /// Returns true if SponsoredProductsUpdateGlobalCampaign instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsUpdateGlobalCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsUpdateGlobalCampaign input)
        {
            if (input == null)
            {
                return false;
