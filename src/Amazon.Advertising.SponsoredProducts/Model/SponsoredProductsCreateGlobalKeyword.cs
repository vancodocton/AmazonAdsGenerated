...
namespace Amazon.Advertising.SponsoredProducts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SponsoredProductsCreateGlobalKeyword")]
    public partial class SponsoredProductsCreateGlobalKeyword : IEquatable<SponsoredProductsCreateGlobalKeyword>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCreateGlobalKeyword" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SponsoredProductsCreateGlobalKeyword() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SponsoredProductsCreateGlobalKeyword" /> class.
        /// </summary>
        ...
        public SponsoredProductsCreateGlobalKeyword(string campaignId = default(string), SponsoredProductsCreateOrUpdateMatchType matchType = default(SponsoredProductsCreateOrUpdateMatchType), string name = default(string), SponsoredProductsCreateOrUpdateGlobalEntityState state = default(SponsoredProductsCreateOrUpdateGlobalEntityState), SponsoredProductsGlobalBid bid = default(SponsoredProductsGlobalBid), string adGroupId = default(string), SponsoredProductsGlobalKeywordText keywordText = default(SponsoredProductsGlobalKeywordText))
        {
            // to ensure "campaignId" is required (not null)
            if (campaignId == null)
            {
                throw new ArgumentNullException("campaignId is a required property for SponsoredProductsCreateGlobalKeyword and cannot be null");
            }
            ...
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for SponsoredProductsCreateGlobalKeyword and cannot be null");
            }
            this.State = state;
            // to ensure "adGroupId" is required (not null)
            if (adGroupId == null)
            {
                throw new ArgumentNullException("adGroupId is a required property for SponsoredProductsCreateGlobalKeyword and cannot be null");
            }
            this.AdGroupId = adGroupId;
            // to ensure "keywordText" is required (not null)
            if (keywordText == null)
            {
                throw new ArgumentNullException("keywordText is a required property for SponsoredProductsCreateGlobalKeyword and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SponsoredProductsCreateGlobalKeyword {\n");
        ...
        {
            return this.Equals(input as SponsoredProductsCreateGlobalKeyword);
        }

        /// <summary>
        /// Returns true if SponsoredProductsCreateGlobalKeyword instances are equal
        /// </summary>
        /// <param name="input">Instance of SponsoredProductsCreateGlobalKeyword to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SponsoredProductsCreateGlobalKeyword input)
        {
            if (input == null)
            {
                return false;
